...
from tests.test_indexer_epilogue import (
    KPOOL,
    POOL_TOPK,
    _make_topk,
    _official_epilogue as _ref_epilogue,
)
...
def test_indexer_epilogue_perf():
    IndexerEpilogueBenchmark(op_name="indexer_epilogue", torch_op=_torch,
                   gems_op=flaggems_vllm.indexer_epilogue, dtypes=[torch.float32]).run()
