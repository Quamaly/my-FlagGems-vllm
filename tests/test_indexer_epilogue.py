...
def _official_epilogue(topk_vals, pool_ids, positions, pool_topk=POOL_TOPK, index_kpool=KPOOL):
...
def test_indexer_epilogue_pool_out():
    ...
    out = flaggems_vllm.indexer_epilogue(tv, pid, positions, 0, POOL_TOPK, KPOOL, pool_out=True)
